...
public class Cgb1903 extends Tarena {
	String like;// 学生兴趣
	static int count;// 班级学生数量统计
	static {// 班级宣传广告
		System.out.println("子类静态代码块: \tJava班宣传广告:只要你想通过学一门编程技术来提升自己");
	}
	{// 报名参加学习
	...
	public Cgb1903(String name, int age, String gender, String like) {// 确定学的内容
		super(name, age, gender);// 集团所有学生都需要提交的信息
		this.like = like;// 特有兴趣方向
		System.out.println("子类构造方法: \t" + this.name + "成功加入Cgb1903班");
	}
